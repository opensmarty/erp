...
class AuthItem extends Model
{
    ...
    public function getItems()
    {
        ...
        $avaliableLabel = [];
        foreach($avaliable as $link=>$group){
            $avaliableLabel[$link] = $link;//Yii::t('route',$link);
        }
        $assignedLabel = [];
        foreach($assigned as $link=>$group){
            $assignedLabel[$link] = $link;//Yii::t('route',$link);
        }
        return[
            'avaliable' => $avaliable,
            'avaliableLabel' => $avaliableLabel,
            'assigned' => $assigned,
