            ...
            <div class="col-xs-12">
                <div class="btn-group pull-right">
                    <div class="btn-group-top">
                        <?= Html::authLink('新增', ['create-issue'], ['class' => 'btn btn-success']) ?>
                ...
                <?= GridView::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'label' => '出处',
                            'attribute' => 'from',
                            'filter'=> Options::serviceIssueFromOptions(),
                            'value' => function ($data) {
                                return Options::serviceIssueFromOptions($data->from);
                            },
                            'format'=>'raw',
                        ],
                        [
                            ...
                            'filter'=>function($data){
                                ...
                                $gets = Yii::$app->request->get('ServiceIssue',[]);
                                $tags = [];
                                if(isset($gets['tags'])){
                                ...
                                $label = rtrim($label,',');
                                $label = $label?:'全部';
                                return '<div class="" style="position: relative;"><span id="filter_display_tags">'.$label.' </span><a href="javascript:;" id="filter_tags_select"><span class="glyphicon glyphicon-pencil"></span></a><input type="hidden" name="ServiceIssue[tags]" value="" id="filter_tags"/><div id="issue_tags_tree" style="position: absolute;top:42px;left:0;background: #FFF;border: solid 1px gray;"></div></div>';
                            },
                            'value' => function ($data) {
                        ...
                        [
                            ...
                            'label' => '状态',
                            'attribute' => 'status',
                            'filter'=> Options::issueStatusOptions(),
                            'value' => function ($data) {
                                return Options::issueStatusOptions($data->status);
                            },
                            'format'=>'raw',
                        ],
                        [
