                ...
                <div class="form-groups">
                    <div class="base-attr">
                        ...
                        <div class="attr-update">
                            <?= $form->field($product, 'template_no')->label('版号')->textInput(['id'=>'template_no']) ?>
                            ...
                            <div class="rings-wrapper" style="display: block;">
                                <fieldset id="first_rings">
                                    ...
                                    <div class="form-group field-productattributes-stone_color">
                                        <label class="control-label" for="productattributes-stone_color">主钻颜色</label>
                                        <?= Html::activeHiddenInput($attributesModel,'stone_color',['class'=>'color-picker-target'])?>
                                        <input type="text" readonly class="form-control color-picker" data-id="productattributes-stone_color"/>
                                ...
                                <fieldset id="first_rings">
                                    ...
                                    <div class="form-group field-productattributes-stone_color">
                                        <label class="control-label" for="productattributes-stone_2_color">主钻颜色</label>
                                        <?= Html::activeHiddenInput($attributesModel,'stone_2_color',['class'=>'color-picker-target'])?>
                                        <input type="text" readonly class="form-control color-picker" data-id="productattributes-stone_2_color"/>
                                        <p class="help-block help-block-error"></p>
                                    </div>
...
$js = <<<JS
    ...
    $(document).on("focusout","#template_no",function(){
        var templateNo = $(this).val();
        var url = '/api/ajax/get-template-info';
        $.post(url,{templateNo:templateNo},function(response){
            if(response.status != '00'){
                return ;
            }
            $.each(response.data,function(name,value){
                var target = $("#productattributes-"+name);
                console.log(name);
                console.log(value !="");
