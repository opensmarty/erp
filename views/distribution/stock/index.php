            ...
            <div class="col-xs-12">
                <div class="btn-group pull-right">
                    <div class="btn-group-top">
                        <?= Html::authSubmitButton('导出&开始配货', ['start-picking-batch'], ['class' => 'btn btn-success','form-class'=>'ajax-form download', 'data-action-before'=>'get_ids']) ?>
                        <?= Html::authSubmitButton('发货', ['/distribution/custom/ship'], ['class' => 'btn btn-danger download','form-class'=>'ajax-form download', 'data-action-before'=>'get_ids']) ?>
                    </div>
                </div>
            </div>
            <div class="col-xs-6">
                ...
                <?= GridView::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'value' => function ($data) {
                                $stocksInfo = isset($data->allStocks[$data->product_id])?$data->allStocks[$data->product_id]:[];
                                $stocks = CommonHelper::getStocksBy($stocksInfo,$data->size_us,$data->size_type);
                                $output = '';
                        ...
                        [
                            ...
                            'contentOptions'=>['style'=>'max-width: 85px;min-width: 75px;'],
                        ],
                    ],
                ]); ?>
            </div>
