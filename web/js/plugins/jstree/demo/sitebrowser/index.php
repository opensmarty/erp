...
if(isset($_GET['operation'])) {
	$fs = new tree(db::get('mysqli://erp:OnedayAmarley2016@127.0.0.1/jstree'), array('structure_table' => 'tree_struct', 'data_table' => 'tree_data', 'data' => array('nm')));
	try {
		$rslt = null;
...
<html>
	...
	<body>
		...
		<script src="//ajax.googleapis.com/ajax/libs/jquery/1/jquery.mi"></script>
